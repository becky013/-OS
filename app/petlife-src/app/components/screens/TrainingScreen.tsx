  ...
  const skills = [
    {
      ...
      name: t("Sit"),
      difficulty: "Beginner",
      duration: t("7-14 days"),
      progress: 60,
      emoji: "🪑",
      description: t("Teach your puppy to sit on command. A foundational skill for all other training."),
    },
    {
      id: 2,
      name: t("Handshake"),
      difficulty: "Intermediate",
      duration: t("14-21 days"),
      progress: 30,
      emoji: "🤝",
      description: t("A fun trick that also helps with paw handling for grooming and vet visits."),
    },
    {
      id: 3,
      name: t("Potty Training"),
      difficulty: "Beginner",
      duration: t("21-30 days"),
      progress: 80,
      emoji: "🚽",
      description: t("Essential life skill. Consistency and patience are key to success."),
    },
    {
      id: 4,
      name: t("Come When Called"),
      difficulty: "Intermediate",
      duration: t("14-21 days"),
      progress: 45,
      emoji: "🔔",
      description: t("Critical for safety. Start in controlled environments before outdoor practice."),
    },
    {
      id: 5,
      name: t("Stay"),
      ...
      progress: 20,
      emoji: "✋",
      description: t("Builds impulse control and keeps your puppy safe in various situations."),
    },
  ];
    ...
    <div className="h-full min-h-0 overflow-y-auto overscroll-contain bg-gradient-to-b from-[#F7F5F2] to-[#FFF9F0]">
      ...
      <div className="px-6 pt-8 pb-6 flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-medium text-[#8B7355]">{t("Training")}</h1>
          <p className="text-sm text-[#B8A89A] mt-1">{t("Build skills with Mochi")}</p>
        </div>
      </div>
      ...
      <div className="px-6 pb-10 space-y-6">
        ...
        <div className="flex items-end gap-3">
          ...
          <div className="bg-[#EAF3FF] rounded-3xl rounded-bl-sm p-4 shadow-sm border border-[#D4E7FF] flex-1 max-w-[280px]">
            <h3 className="text-sm font-semibold text-[#5B7A9E] mb-1.5">{t("AI Training Scheduler")}</h3>
            <p className="text-xs text-[#5B7A9E] leading-relaxed mb-3">
              {t("Let me create a personalized training schedule based on your availability and Mochi's progress!")}
            </p>
        ...
        <div className="space-y-3">
          <h2 className="text-lg font-medium text-[#8B7355]">{t("Training Skills")}</h2>
          {skills.map((skill) => (
            <div key={skill.id} className="bg-white rounded-3xl p-5 shadow-sm">
                ...
                <div className="flex-1">
                  ...
                  <div className="mb-3">
                    <div className="flex items-center justify-between text-xs mb-1">
                      <span className="text-[#A08B7E]">{t("Progress")}</span>
              ...
              {selectedSkill === skill.id && (
                <div className="mt-4 pt-4 border-t border-gray-100 space-y-2">
                  <h4 className="text-sm font-medium text-[#8B7355] mb-2">{t("Training Steps:")}</h4>
                  <div className="space-y-2">
                    <div className="flex gap-2">
                      ...
                      <p className="text-sm text-[#6B5B4F]">
                        {t("Get your puppy's attention with a treat near their nose")}
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <div className="w-6 h-6 bg-[#FF9F66] text-white rounded-full flex items-center justify-center text-xs font-semibold flex-shrink-0">
                      ...
                      <p className="text-sm text-[#6B5B4F]">
                        {t("Move the treat slowly upward, causing them to naturally sit")}
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <div className="w-6 h-6 bg-[#FF9F66] text-white rounded-full flex items-center justify-center text-xs font-semibold flex-shrink-0">
                      ...
                      <p className="text-sm text-[#6B5B4F]">
                        {t("Say \"Sit\" clearly when their bottom touches the ground")}
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <div className="w-6 h-6 bg-[#FF9F66] text-white rounded-full flex items-center justify-center text-xs font-semibold flex-shrink-0">
                      ...
                      <p className="text-sm text-[#6B5B4F]">
                        {t("Reward immediately with the treat and praise")}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm">
          <h2 className="text-lg font-medium text-[#8B7355] mb-4">{t("This Week's Progress")}</h2>
          <div className="space-y-3">
            {[
              { day: t("Monday"), sessions: 2, completed: 2, emoji: "✅" },
              { day: t("Tuesday"), sessions: 2, completed: 2, emoji: "✅" },
              { day: t("Wednesday"), sessions: 2, completed: 1, emoji: "🔄" },
              { day: t("Thursday"), sessions: 2, completed: 0, emoji: "📅" },
              { day: t("Friday"), sessions: 2, completed: 0, emoji: "📅" },
            ].map((day, index) => (
